...
export class CreateTenantsTable1740787200100 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'timezone', type: 'varchar', isNullable: false, default: "'Europe/Berlin'" },
    ...
    await queryRunner.createIndex('tenants', new TableIndex({ name: 'uq_tenants_slug', columnNames: ['slug'], isUnique: true }));
  }
