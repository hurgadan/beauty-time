...
export class CreateNotificationJobsTable1740787200600 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'channel', type: 'enum', enumName: 'notification_channel_enum', enum: ['email'], isNullable: false },
          ...
          { name: 'attempts', type: 'integer', default: '0', isNullable: false },
    ...
    await queryRunner.createForeignKey(
      'notification_jobs',
      new TableForeignKey({ name: 'fk_notification_jobs_tenant_id', columnNames: ['tenant_id'], referencedTableName: 'tenants', referencedColumnNames: ['id'], onDelete: 'CASCADE' }),
    );
    await queryRunner.createForeignKey(
      'notification_jobs',
      new TableForeignKey({ name: 'fk_notification_jobs_appointment_id', columnNames: ['appointment_id'], referencedTableName: 'appointments', referencedColumnNames: ['id'], onDelete: 'SET NULL' }),
    );
  }
