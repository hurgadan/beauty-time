...
export class BookingController {
  ...
  public getConfig(@Param('bookingSlug') bookingSlug: string): BookingConfigResponseDto {
  ...
  public queryAvailability(
    ...
    @Body() _dto: AvailabilityQueryRequestDto,
  ...
  public createAppointment(
    @Param('bookingSlug') bookingSlug: string,
    @Body() _dto: CreatePublicAppointmentRequestDto,
  ...
  public confirmAppointment(@Param('id') id: string): ConfirmAppointmentResponseDto {
